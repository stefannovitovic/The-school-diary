...
<div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <a href="chatbox.php" rel="noopener noreferrer" style="color: wheat;">Compose</a>
                    </div>
                    </div>
                    <ol class="breadcrumb">
                        <li>
                            ...
                            foreach ($row as $message){
                                ?>
                                  <tr>
                                      ...
                                      <td><a href="answer_message.php?answer=<?php echo $message->messages_id; ?>&sender=<?php echo $message->parent_id; ?>">Odogovori na poruku</a></td>
                                  </tr>
